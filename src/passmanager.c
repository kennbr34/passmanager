...
const EVP_CIPHER *evpCipher1, *evpCipher1Old, *evpCipher2; /*This holds the cipher_ctx pinter needed by EVP functions*/
unsigned char evpKey1[EVP_MAX_KEY_LENGTH], evpKey1Old[EVP_MAX_KEY_LENGTH],evpKey2[EVP_MAX_KEY_LENGTH]; /*buffer for key for EVP encryption will be generated by EVP_BytesToKey*/
unsigned char evpIv1[EVP_MAX_IV_LENGTH], evpIv1Old[EVP_MAX_KEY_LENGTH],evpIv2[EVP_MAX_IV_LENGTH]; /*buffer for evpIv2, will also be generated if needed*/
